        ...
        <div wire:key="{{ $todoItem->id }}" class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 hover:shadow">
            ...
            <div class="flex justify-between space-x-2">
                ...
                <h3 class="text-lg text-semibold text-gray-800">{{ $todoItem->name??'' }}</h3>
            ...
            <span class="text-xs text-gray-500"> {{ date('d M Y',strtotime($todoItem->created_at)) }} </span>
